...
/**
 * Factory for creating configured instances of {@link org.apache.flink.streaming.connectors.kafka.KafkaAvroTableSource}.
 */
public abstract class KafkaAvroTableSourceFactory extends KafkaTableSourceFactory {
	...
	protected KafkaTableSource.Builder createBuilderWithFormat(DescriptorProperties params) {
		org.apache.flink.jerry.KafkaAvroTableSource.Builder builder = createKafkaAvroBuilder();
	...
	/**
	 * Creates a version specific {@link org.apache.flink.streaming.connectors.kafka.KafkaAvroTableSource.Builder}.
	 */
	protected abstract org.apache.flink.jerry.KafkaAvroTableSource.Builder createKafkaAvroBuilder();
}
