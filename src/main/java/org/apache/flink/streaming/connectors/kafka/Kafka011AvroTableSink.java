...
public class Kafka011AvroTableSink extends KafkaAvroTableSink {
	 ...
	 */
	public Kafka011AvroTableSink(String topic, Properties properties, Class<? extends SpecificRecord> recordClazz) {
		super(topic, properties, new FlinkFixedPartitioner<>(), recordClazz);
	}
	 ...
	 */
	public Kafka011AvroTableSink(String topic, Properties properties, FlinkKafkaPartitioner<Row> partitioner,Class<? extends SpecificRecord> recordClazz) {
		super(topic, properties, partitioner, recordClazz);
	}
	...
	protected Kafka011AvroTableSink createCopy() {
		return new Kafka011AvroTableSink(topic, properties, partitioner, recordClazz);
	}
}
