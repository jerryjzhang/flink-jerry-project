...
public class Kafka011AvroTableSource extends KafkaAvroTableSource {
	...
	/**
	 * A builder to configure and create a {@link org.apache.flink.streaming.connectors.kafka.Kafka011AvroTableSource}.
	 */
	public static class Builder extends KafkaAvroTableSource.Builder<org.apache.flink.jerry.Kafka011AvroTableSource, org.apache.flink.jerry.Kafka011AvroTableSource.Builder> {
		...
		@Override
		protected org.apache.flink.jerry.Kafka011AvroTableSource.Builder builder() {
			return this;
		}

		/**
		 * Builds and configures a {@link org.apache.flink.streaming.connectors.kafka.Kafka011AvroTableSource}.
		 *
		 * @return A configured {@link org.apache.flink.streaming.connectors.kafka.Kafka011AvroTableSource}.
		 */
		@Override
		public org.apache.flink.jerry.Kafka011AvroTableSource build() {
			org.apache.flink.jerry.Kafka011AvroTableSource tableSource = new org.apache.flink.jerry.Kafka011AvroTableSource(
				getTopic(),
				getKafkaProps(),
				getTableSchema(),
				getAvroRecordClass());
